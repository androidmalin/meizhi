...
echo "65-----------------------------------"
cd $path/testutils/25.3.0
wget -c $baseurl/testutils/25.3.0/testutils-25.3.0-sources.jar -O testutils-25.3.0-sources.jar
wget -c $baseurl/testutils/25.3.0/testutils-25.3.0-javadoc.jar -O testutils-25.3.0-javadoc.jar
